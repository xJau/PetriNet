...
public class NetworksManager {
    ...
    public static class NetworkManager {
        ...
        public void selectNet() {
            ...
            int input;
            if (nets.isEmpty())
                nets.add(new Network(0, "Rete zero"));
            ...
            do {
                ...
                if (input == -1)
                    return;
                else if (input < 0 || input > netsSize)
                    menu.printValue();
                else if (input == netsSize)
                    createNet();
                else
                    modifyNet(nets.get(input));
        ...
        public void addPlace() {
            ...
            activeNetwork.addPlace(activeNetwork.getPlaces().size(), activeNetwork.getTransitions().get(input),
                    ingoingbool);
        }
        ...
        public void addTransition() {
            ...
            activeNetwork.addTransition(activeNetwork.getTransitions().size(), activeNetwork.getPlaces().get(input),
                    ingoingbool);
        }
        ...
        public void setNetName() {
            ...
            do {
                nuovoNome = inString();
                if (!nuovoNome.toLowerCase().replaceAll("[^a-z]", "").equals("name"))
                    break;
                menu.printValue();
            } while (true);
