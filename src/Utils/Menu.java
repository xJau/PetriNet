...
public class Menu {
    ...
    private final String NET_FATHER_DONT_EXIST = "La rete padre non � presente tra quelle salvate in forma persistente, "
    		+ "quindi non � possibile importare la rete desiderata";
    private final String FILE_VUOTO_O_NON_COMPATIBILE = "Il file selezionato � vuoto o non compatibile";
    private final String RETE_NON_CONNESSA = "La rete selezionata non � connessa";
